  ...
  $(document).on('turbolinks:load', function() {
      ...
      $.ajax(e.target.action, {
        ...
        error: function(jqXHR, textStatus, errorThrown) {
          return bulmaToast.toast({
            message: 'Problema na atualização da Campanha',
            type: 'is-danger',
            position: 'is-bottom'
          });
        }
    ...
    $('.remove_campaign').on('submit', function(e) {
      $.ajax(e.target.action, {
        ...
        error: function(jqXHR, textStatus, errorThrown) {
          return bulmaToast.toast({
            message: 'Problema na remoção da Campanha',
            type: 'is-danger',
            position: 'is-bottom'
          });
        }
    ...
    return $('.raffle_campaign').on('submit', function(e) {
      $.ajax(e.target.action, {
        ...
        success: function(data, text, jqXHR) {
          return bulmaToast.toast({
            message: 'Tudo certo, em breve os participantes receberão um email!',
            type: 'is-success',
            position: 'is-bottom'
          });
        },
...
(function() {
  ...
  $(document).on('turbolinks:load', function() {
    ...
    $('body').on('click', 'a.remove_member', function(e) {
      $.ajax('/members/' + e.currentTarget.id, {
        ...
        error: function(jqXHR, textStatus, errorThrown) {
          return bulmaToast.toast({
            message: 'Problema na remoção do Membro',
            type: 'is-danger',
            position: 'is-bottom'
          });
        }
    ...
    return $('.new_member').on('submit', function(e) {
      $.ajax(e.target.action, {
        ...
        error: function(jqXHR, textStatus, errorThrown) {
          return bulmaToast.toast({
            message: 'Problema na inclusão de Membro',
            type: 'is-danger',
            position: 'is-bottom'
          });
        }
  ...
  insert_member = function(id, name, email) {
    return $('.member_list').append('<div class="member" id="member_' + id + '">' + '<div class="field is-horizontal mt">' + '<div class="field-label is-normal"><label class="label has-text-warning ">Nome / E-mail</label></div>' + '<div class="field-body">' + '<div class="field">' + '<p class="control is-expanded has-icons-left">' + '<input id="name" class="validate input is-rounded is-warning" type="text" value="' + name + '">' + '<span class="icon is-small is-left">' + '<i class="fas fa-user"></i>' + '</span>' + '</p>' + '</div>' + '<div class="field">' + '<p class="control is-expanded has-icons-left">' + '<input class="input is-rounded is-warning" type="email" value="' + email + '">' + '<span class="icon is-small is-left">' + '<i class="fas fa-envelope"></i>' + '</span>' + '</p>' + '</div>' + '<div class="icons is-flex">' + '<span class="icon is-normal">' + '<i class="fas fa-eye"></i>' + '</span>' + '<a href="#" class="remove_member" id="' + id + '">' + '<span class="icon is-normal has-text-danger">' + '<i class="fas fa-trash"></i>' + '</span>' + '</a>' + '</div>' + '</div>' + '</div>' + '</div>');
  };
